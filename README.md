...
#### Thống kê tuần
Sử dụng lệnh `/weekly_summary` để xem thống kê món ăn trong tuần.

#### Thống kê tháng
Sử dụng lệnh `/monthly_summary` để xem thống kê món ăn trong tháng.
...
| `/weekly_summary` | Xem thống kê đặt món tuần này |
| `/monthly_summary` | Xem thống kê đặt món tháng này |
